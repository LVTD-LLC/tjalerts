...
AI_RESULT_RETRIES = env.int("AI_RESULT_RETRIES", default=2)
AI_JOB_EXTRACTION_MODEL = env(
    "AI_JOB_EXTRACTION_MODEL",
    default=env("OPENAI_JOB_EXTRACTION_MODEL", default="openai/gpt-5.4-nano"),
)
AI_PAGE_CONTEXT_EXTRACTION_MODEL = env(
    "AI_PAGE_CONTEXT_EXTRACTION_MODEL",
    default=env("OPENAI_PAGE_CONTEXT_EXTRACTION_MODEL", default="google/gemini-2.5-flash-lite"),
)
AI_SALARY_EXTRACTION_MODEL = env(
    "AI_SALARY_EXTRACTION_MODEL",
    default=env("OPENAI_SALARY_EXTRACTION_MODEL", default="openai/gpt-5-nano"),
)
AI_EMBEDDING_MODEL = env(
    "AI_EMBEDDING_MODEL",
    default=env("OPENAI_EMBEDDING_MODEL", default="openai/text-embedding-3-small"),
)
AI_EMBEDDING_DIMENSIONS = env.int("AI_EMBEDDING_DIMENSIONS", default=1536)

OPENAI_API_KEY = env("OPENAI_API_KEY", default=OPENROUTER_API_KEY)
OPENAI_JOB_EXTRACTION_MODEL = AI_JOB_EXTRACTION_MODEL
OPENAI_PAGE_CONTEXT_EXTRACTION_MODEL = AI_PAGE_CONTEXT_EXTRACTION_MODEL
OPENAI_SALARY_EXTRACTION_MODEL = AI_SALARY_EXTRACTION_MODEL
OPENAI_EMBEDDING_MODEL = AI_EMBEDDING_MODEL
